...
export const COMMENT_GREETING = `<img src="https://0.gravatar.com/avatar/49690a9fa3bd886f3eaed1220426c083365fc62543f60289e607ab1d7eb6c818?size=128" alt="Image description" width="20" height="20">   DC`;

export const COMMENT_TAG = "<!-- This is an auto-generated comment by DC -->";

export const COMMENT_REPLY_TAG =
  "<!-- This is an auto-generated reply by DC -->";

export const SUMMARIZE_TAG =
  "<!-- This is an auto-generated comment: summarize by noye.org -->";

export const IN_PROGRESS_START_TAG =
  "<!-- This is an auto-generated comment: summarize review in progress by noye.org -->";

export const IN_PROGRESS_END_TAG =
  "<!-- end of auto-generated comment: summarize review in progress by noye.org -->";

export const DESCRIPTION_START_TAG = `
<!-- This is an auto-generated comment: release notes by noye.org -->`;
export const DESCRIPTION_END_TAG =
  "<!-- end of auto-generated comment: release notes by noye.org -->";

export const RAW_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: raw summary by noye.org -->
<!--
`;
export const RAW_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: raw summary by noye.org -->`;

export const SHORT_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: short summary by noye.org -->
<!--
`;

export const SHORT_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: short summary by noye.org -->`;
